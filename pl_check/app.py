...
st.title("AI Plagiarism Detector : Evaluates the Text Input Contents")
...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            if perplexity > 10000 and burstiness_score < 0.5:
                st.error("Text Analysis Result: AI generated content")
            else:
                st.success("Text Analysis Result: Likely not generated by AI")
